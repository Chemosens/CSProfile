...
{# if data mul
  ...
  ## conditions d'utilisation de la fonction scalesensperf :
    ...
    modelType=option
    resultatPerf=PanelPerformances(frame=dataRes2, modelType=option,negativeCorrection=negativeCorrection,correctOnlyIfSignificant=correctOnlyIfSignificant,
	                               limitOfSignificance=0.05,onlySignificantDim=FALSE,manovaTest="Hotelling", panelistPerf=TRUE,correlationTest=correlationTest,levelOption=levelOption,whenOverallUseMAMForTest=TRUE)
	...
	individualScaling=resultatPerf$Beta
   ...
   # significanceMatrix=significanceMatrix[ind2,ind]
    ...
    individualScalingF=individualScalingF[ind2,ind]
