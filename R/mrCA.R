...
#' @param nbaxes.sig The number of significant axes retuned by mr.dimensionality.test. By default, all axes are considered significant. Useless when ellipse=FALSE. See details
