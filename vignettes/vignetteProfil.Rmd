---
title: "Statistical analysis of profile with chemosensR package"
date: "`r Sys.Date()`"
output:
  html_document:
    toc: yes
...
# Introduction
chemosensR aims to analyze data from different protocols of sensory analysis -especially providing from TimeSens software ,but not only-. 
...
```{r, echo=FALSE}
htmltools::includeHTML("Flash table.html")
```
